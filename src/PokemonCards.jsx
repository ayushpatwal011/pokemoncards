...
const PokemonCard = ({ poke }) => {
  return (
    <div className={`relative bg-white shadow-md rounded-lg flex justify-center items-center  border border-gray-200 w-36 h-36  md:w-64 md:h-64 hover:bg-gray-200 hover:origin-top-left hover:rotate-2 duration-500 `}>
      {/* ID */}
